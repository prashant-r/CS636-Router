...
static unsigned long next_expiration;
...
/*---------------------------------------------------------------------------*/
void
etimer_set(struct etimer *et, unsigned long interval)
{
...
/*---------------------------------------------------------------------------*/
void
etimer_reset_with_new_interval(struct etimer *et, unsigned long interval)
{
